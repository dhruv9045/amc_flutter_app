...
class IntellectualPdf extends StatelessWidget{
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: new AppBar(
        ...
        title: new Center(child: new Text('Intellectual Property Right', textAlign: TextAlign.center)),
...
class _IntellectualState extends State<Intellectual>{
  ...
  String url = "images/pdf/intellectual_property.pdf";
  bool _isloading;
  PDFDocument _doc;
